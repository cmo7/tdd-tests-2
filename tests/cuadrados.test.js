...
describe('La función esCuadrado', () => {
    test('retorna true cuando se evalúa un número que tiene raiz '+
    'cuadrada entera',
    () => {
    ...
    test('retorna false cuando se evalúa un número que no tiene raiz '+
    'cuadrada entera',
    () => {
...
describe('La función todosSonCuadrados', () => {
    test('retorna true si evalua un array cuyos elementos son todos cuadrados',
        () => {
            expect(todosSonCuadrados([4, 9])).toBe(true);
